...
class Scenario(BaseScenario): #在reset的时候 修改用户比例
    f = open('/root/com_navi_latest/maddpg_communicate_navigation_uav_latest/multiagent-particle-envs-master/multiagent/scenarios/location50.json')
    ...
    def reset_world(self, world):
        ...
        # with open("/root/com_navi_latest/maddpg_communicate_navigation_uav_latest/multiagent-particle-envs-master/multiagent/scenarios/deployment50.json", 'a+', newline='\n') as f:
        #     f.write(data)
        #     f.write(',')
        #     f.write('\n')
        for i, agent in enumerate(world.agents):
        ...
        # with open("/root/com_navi_latest/maddpg_communicate_navigation_uav_latest/multiagent-particle-envs-master/multiagent/scenarios/deployment_time50.csv", 'a+', newline='\n') as f:
