...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None, whole_rew = None,success_sum = None,
                 observation_callback=None, info_callback=None,
                 done_callback=None, shared_viewer=True):
        #self.viewer = viewer  # None则可视化  可以自定义图层
        self.world = world
    ...
    def step(self, action_n):
        ...
        for agent in self.agents:
            ...
            whole_com_nav_n.append(self._get_whole(agent))
            success_sum_n.append(self._get_success(agent))
        ...
        #返回所有agent的观测
        return obs_n, reward_n,whole_com_nav_n ,success_sum_n,done_n, info_n
    ...
    def _get_whole(self,agent):
        if self.whole_rew is None:
            return 0.0
        return self.whole_rew(agent, self.world)
    
    def _get_success(self,agent):
        if self.success_sum is None:
            return 0.0
        return self.success_sum(agent, self.world)
